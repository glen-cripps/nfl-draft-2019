...
training_data = select(imputed_data[imputed_data$year<=2017,], pick, first_round_pick,
                       ...
                       , receiving.games , receiving.rec.avg
                       , receiving.rec.td , receiving.rec.yards , receiving.seasons)
...
plot(training_data$receiving.rec.td ~ training_data$pick  )
lm(training_data$receiving.rec.td ~ training_data$pick )
abline(21.53, 0.02233  )
