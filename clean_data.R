...
combine.table <- read_feather('/home/hduser/Dropbox/Analytics/nfl_draft/combines.feather')
draft.table <- read_feather('/home/hduser/Dropbox/Analytics/nfl_draft/drafts.feather')
college.stats <- read_feather('/home/hduser/Dropbox/Analytics/nfl_draft/college_stats.feather')
